...
import at.trinkl.Omimon.Battle.AttackEffects.CriticalAttack;
import at.trinkl.Omimon.Battle.AttackEffects.FollowAttack;
import at.trinkl.Omimon.Battle.AttackEffects.HealAttack;
import at.trinkl.Omimon.Battle.Strategy.BattleStrategy.RandomBattleStrategy;
import at.trinkl.Omimon.Battle.Strategy.BattleStrategy.SmartBattleStrategy;
import at.trinkl.Omimon.Battle.Strategy.BattleStrategy.StrengthBattleStrategy;
...
/**
 * The {@code Omidex} is a singleton registry that stores all known {@link OmimonBlueprint}s and
 * {@link Attack}s in the game.
 * <p>
 * It serves as a central source for fetching blueprints and attacks by name. The data is
 * initialized lazily on first access via {@link #getInstance()} and remains globally available
...
public class Omidex {
  ...
  /**
   * Returns the singleton instance of {@code Omidex}. If it hasn't been initialized yet, all
   * predefined {@link Attack}s and {@link OmimonBlueprint}s will be created and stored.
   *
   * @return The global instance of {@code Omidex}.
   */
  ...
  /**
   * Retrieves an {@link OmimonBlueprint} by name.
   *
   * @param blueprintName The name of the blueprint.
   * @return The matching {@link OmimonBlueprint}.
   * @throws IllegalArgumentException if no blueprint with the given name exists.
   */
  ...
  /**
   * Retrieves an {@link Attack} by name.
   *
   * @param attackName The name of the attack.
   * @return The matching {@link Attack}.
   * @throws IllegalArgumentException if no attack with the given name exists.
   */
  ...
  /**
   * Creates and registers all predefined {@link OmimonBlueprint}s used in the game. TESTING ONLY.
   *
  ...
  /**
   * Creates and registers all predefined {@link Attack}s used in the game. TESTING ONLY.
   *
   * @return A map of attack names to {@link Attack} objects.
   */
