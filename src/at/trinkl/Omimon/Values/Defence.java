 ...
 * <p>
 * Defence influences how much damage an Omimon receives when attacked. The higher the value, the
 * more damage can be mitigated depending on the damage formula.
 * </p>
 * <p>
 * Values are automatically clamped to the valid range of {@code [0, 255]} as defined by
 * {@link BaseValue}.
 * </p>
 */
